...
| **Geniş uygulama kataloğu** | Tek tık kurulum WordPress, Joomla, PrestaShop, Drupal, OpenCart, Matomo ve Grav için; diğer PHP uygulamaları sırada. |
...
- Tek-tık **WordPress**, **Joomla**, **PrestaShop**, **Drupal**, **OpenCart**, **Matomo** ve **Grav** kurulumu; sürüm algılama ve desteklenen uygulamalarda panelden çekirdek güncelleme
