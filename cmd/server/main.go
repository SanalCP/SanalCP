	...
	r.Route("/api/v1", func(r chi.Router) {
		...
		r.Group(func(r chi.Router) {
			...
			r.Group(func(r chi.Router) {
				...
				r.With(middleware.AdminOnly).Post("/admin/transfers/remote/access-key", transfersH.RemoteAccessKey)
				r.With(middleware.AdminOnly).Post("/admin/transfers/remote/host-key/scan", transfersH.RemoteHostKeyScan)
				r.With(middleware.AdminOnly).Post("/admin/transfers/remote/host-key/trust", transfersH.RemoteHostKeyTrust)
