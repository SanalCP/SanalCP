  ...
  return (
    <div>
      <Grup baslik={t('DomainPano:groups.apps')}>
        ...
        <ToolCard etiket={t('DomainPano:items.laravel_tools')} aciklama={t('DomainPano:items.laravel_tools_desc')} ikon={ICONS.laravel} renk="rose" onClick={git('laravel')} />
      </Grup>
      ...
      <Grup baslik={t('DomainPano:groups.dev_tools')}>
        <ToolCard etiket={t('DomainPano:items.apache_nginx')}          aciklama={t('DomainPano:items.apache_nginx_desc')} ikon={ICONS.apache} renk="orange" onClick={git('web-sunucu')} />
