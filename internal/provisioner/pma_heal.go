...
//   - /opt/sanalcp/pma-signon/pma-signon.php  → host='localhost' (yoksa/eskiyse yaz)
//   - /etc/sanalcp/pma-internal.token         → yoksa üret (root:apache 0640)
...
func ensurePMAToken() {
	...
	log.Printf("pma heal: /etc/sanalcp/pma-internal.token üretildi")
}
