...
| **Broad application catalog** | One-click installation supports WordPress, Joomla, PrestaShop, Drupal, OpenCart, Matomo, and Grav; more PHP applications are planned. |
...
- One-click **WordPress**, **Joomla**, **PrestaShop**, **Drupal**, **OpenCart**, **Matomo**, and **Grav** installation, version detection, and core updates where supported
